...
class GuardianContactPage extends Component {
	constructor(props) {
        super(props);
                ...
                <View style={ [ Styles.centerContainer, Styles.normalMargin, Styles.hideLogoByBackground] } >
                    <View style={ [style.container] } >
                        ...
                        <TextInput 
                            ...
                            placeholder='Guardian Contact Person' 
...
GuardianContactPage.navigatorStyle = {
    navBarHidden: true,
...
export default connect(mapStateToProps, mapDispatchToProps)(GuardianContactPage);